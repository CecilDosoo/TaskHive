...
export default function Register() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Registration successful - redirect to resend verification page
    ...
    <div className="flex items-center justify-center" style={{ 
      ...
      <div className="w-full max-w-md p-10 bg-white rounded-2xl shadow-2xl" style={{ boxShadow: '0 20px 60px rgba(0,0,0,0.3)' }}>
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 text-sm">Join TaskHive and start collaborating</p>
        </div>
        ...
        <div className="mt-6 text-center text-sm">
          <p className="text-gray-600">
            ...
            <Link to="/" className="font-semibold transition-colors" style={{ color: '#667eea' }}>
              Sign in
            </Link>
          </p>
        </div>
